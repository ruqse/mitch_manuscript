...
#   supplementary_tables/Table_S5.xlsx    (PERMANOVA results)
#   supplementary_tables/Table_S6.xlsx    (taxonomic DA, ANCOM-BC2)
#   supplementary_tables/Table_S7.xlsx    (pathway DA, ANCOM-BC2)
#   supplementary_tables/Table_S8.xlsx    (metabolomics positive mode, limma)
#   supplementary_tables/Table_S9.xlsx    (metabolomics negative mode, limma)
#   supplementary_tables/Table_S10.xlsx    (DIABLO variance explained)
#   supplementary_tables/Table_S11.xlsx    (DIABLO feature loadings)
...
res_raw %>%
  dplyr::select(taxon, lfc_GroupBV, q_GroupBV) %>%
  openxlsx::write.xlsx(file = "supplementary_tables/Table_S6.xlsx")
...
openxlsx::write.xlsx(bv_path_res, file = "supplementary_tables/Table_S7.xlsx")
...
results_braycurtis_multivariate_tibble %>%
  ...
  openxlsx::write.xlsx(file = "supplementary_tables/Table_S5.xlsx")
...
openxlsx::write.xlsx(tt_adj_pos, file = "supplementary_tables/Table_S8.xlsx")
...
openxlsx::write.xlsx(tt_adj_neg, file = "supplementary_tables/Table_S9.xlsx")
...
openxlsx::write.xlsx(all_selected_features, file = "supplementary_tables/Table_S11.xlsx")
...
var_df %>%
  ...
  openxlsx::write.xlsx(file = "supplementary_tables/Table_S10.xlsx")
